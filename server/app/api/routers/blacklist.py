...
from server.app.models import BlacklistAddress, User
from server.app.auth import (
    AuthService, get_current_user, require_permission, Permissions
)
from server.app.responses import StandardResponse, ResponseMessages
from server.app.logging_middleware import Operations
from server.app.query_params import BlacklistQueryParams, apply_pagination, get_total_count
...
async def add_blacklist_address(
    ...
    try:
        ...
        # 记录操作日志
        from server.app.logging_middleware import OperationLogger
